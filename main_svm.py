...
def main():
    st.title("Install scikit-learn via Streamlit")
    st.write("Klik tombol di bawah untuk menginstal scikit-learn")

    if st.button("Install scikit-learn"):
        st.write("Memulai proses instalasi...")
        install_package('scikit-learn')
        st.write("Instalasi selesai. Silakan restart aplikasi Streamlit.")
